...
def checkifwon():
    ...
    if b1["text"] == "X" and b2["text"] == "X" and b3["text"] == "X":
        ...
        b3.config(bg="red")
        winner = True
        messagebox.showinfo("Tic Tac Toe", "PARABÉNS!  Jogador X venceu!!")
        disable_all_buttons()
    ...
    # checa se O venceu
        ...
        b3.config(bg="red")
        winner = True
        messagebox.showinfo("Tic Tac Toe", "PARABÉNS!  Jogador O venceu!!")
        disable_all_buttons()
...
def b_click(b):
    ...
    if b["text"] == " " and clicked == True:
        ...
        messagebox.showerror(
            "Tic Tac Toe", "Espaço já preenchido\nEscolha outro...")
...
def reset():
    ...
    # Trazendo os botões para a tela
...
my_menu.add_cascade(label="Opções", menu=options_menu)
options_menu.add_command(label="Recomeçar", command=reset)
